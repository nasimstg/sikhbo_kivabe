...
Comes with an open and close tag. Some examples of common HTML tags include:
...
Another example is the `<a>` tag used to create hyperlinks. The `<a>` tag has an attribute called href that indicates the URL of the linked page.
    ...
    ```
This will create a link called "Example" and when clicked, it will take the user to the "www.example.com" website.
...
- ### `<header>`
  ...
  ```
- ### `<nav>`
  It is used to define a set of navigation links.
